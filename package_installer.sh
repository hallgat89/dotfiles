...
APPS='rofi feh install geany astyle pcmanfm sakura nomacs redshift xzoom seahorse gnome-keyring libsecret-tools volumeicon-alsa xfonts-terminus usb-creator-gtk parcellite psensor lm-sensors gimp language-selector-common vlc numlockx nm-applet mcomix qpdfview qmmp qmmp-plugin-projectm  compton compton-conf'
