...
APPS='rofi feh install geany astyle pcmanfm sakura nomacs redshift exo-utils xzoom seahorse gnome-keyring libsecret-tools pnmixer xfonts-terminus usb-creator-gtk parcellite psensor lm-sensors gimp language-selector-common vlc numlockx nm-applet mcomix qpdfview qmmp qmmp-plugin-projectm nitrogen compton compton-conf'
